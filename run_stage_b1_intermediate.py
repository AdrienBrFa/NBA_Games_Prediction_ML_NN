...
# Stage configuration
STAGE_NAME = "stage_b1_intermediate"
...
def main(threshold_metric="f1"):
    """Run the complete Stage B1 Intermediate pipeline."""
    print("="*80)
    ...
    # Step 2B: Engineer Stage B1 team statistics features (intermediate)
    print("\n" + "="*80)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run Stage B1 Intermediate pipeline with configurable threshold optimization")
    parser.add_argument(
        "--threshold_metric",
        type=str,
        default="f1",
